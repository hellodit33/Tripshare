...
async function getDataFromStrapi() {
    ...
    //if the user did not add any map
        ...
        <div class="row">
            ...
            <p class="geolocation">${obj.geolocation.data.attributes.Place}</p>

        
            <p class="geolocation">${obj.preferences.data[0].attributes.Preference}</p>
    
            <p class="geolocation">${obj.preferences.data[1].attributes.Preference}</p>
        </div>
